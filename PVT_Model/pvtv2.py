...
class PyramidVisionTransformerV2(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=39, num_classes=1000, embed_dims=[64, 128, 256, 512],
    ...
    def init_weights(self, pretrained=None):
        if isinstance(pretrained, str):
            print('from {} load pretrained...'.format(pretrained))
...
class pvt_v2_b2(PyramidVisionTransformerV2):
    def __init__(self, **kwargs):
        super(pvt_v2_b2, self).__init__(
            in_chans=3, patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
